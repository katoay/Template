        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    {{-- <h3 class="text-lg font-medium leading-6 text-gray-900">ข้อมูล
                        Table Line</h3> --}}
                            ...
                            <!--begin::Input group-->
                                @if($item['show'] == 'true')
                                    <div class="col-span-6 mt-2 sm:col-span-3">
                                        <label class="block text-sm font-medium text-gray-900  {{$item['require'] == 'true' ? 'required' : ''}} ">{{$item['label']}} </label>
                                        <div>
